...
Arba tiesiogiai per Paysera (paspaudus mygtuką arba nuskaičius QR kodą):

![QR kodas](../../../assets/images/PaySera.png)
...
Taip pat kviečiame paremti per Contribee platformą: <a href="https://contribee.com/lt/rathajatravilnius/post/102072" target="_blank" rel="noopener noreferrer">Paremkite per Contribee</a>

Kviečiame tapti šios gražios šventės dalimi ir kartu sukurti kažką ypatingo Vilniui.

<style>
.markdown-body img[alt="QR kodas"] {
    width: 150px;
    height: 150px;
    display: block;
    margin: 1.5rem 0;
