import pic02 from '../../assets/images/aikste-31.webp'
import pic03 from '../../assets/images/aikste-38.webp'

const Programa = () => {
  return (
    <article id="kur" >
      <h2 className="major">Programa</h2>
      ...
      <p>
        Bharata Natyam – klasikinis indų šokio stilius, kilęs iš Pietų Indijoje
        esančio Tamil Nadu regiono. Pavadinimas Bharata Natyam yra sudarytas iš
        žodžių: bhava – jausmas, raga – melodija, tala – ritmas ir natyam –
        šokis. Tai dinamiškas ir labai tikslus šokio stilius, pasižymintis
        grakštumu ir tuo pat metu jėga.
      </p>
      <p>
        Daugiau apie šiuos šokius galite sužinoti adresu:
        <br />
        <a href="https://www.indiskisokiai.lt/indijos-sokis/">
